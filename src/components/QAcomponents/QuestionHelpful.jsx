...
const QuestionHelpful = ({helpfulness, questionId}) => {
  ...
  let urlHelpful = `${process.env.REACT_APP_ENDPOINT}qa/questions/${questionId}/helpful`;
  ...
  let urlReport = `${process.env.REACT_APP_ENDPOINT}qa/questions/${questionId}/report`;
  const handleReport = () => {
    if (!questionId) {
      return;
    }
